...
import '../../news/component/trending_topic.dart';
import '../component/news_page.dart';

class NewsBengkelly extends StatefulWidget {
  const NewsBengkelly({super.key});

  @override
  State<NewsBengkelly> createState() => _NewsBengkellyState();
}

class _NewsBengkellyState extends State<NewsBengkelly> {
  ...
  void _loadPosts() async {
    ...
    try {
      List<RssFeed> newPosts =
          await api.fetchPagingBengkellyNews(page: currentPage);
      setState(() {
        currentPage++;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        ...
        TrendingTopicPage(onPressed: (RssFeed? data) {
          Navigator.push(
            context,
            MaterialPageRoute(
