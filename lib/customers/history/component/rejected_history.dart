...
class RejectedHistory extends StatefulWidget {
  const RejectedHistory({super.key});

  @override
  State<RejectedHistory> createState() => _RejectedHistoryState();
}

class _RejectedHistoryState extends State<RejectedHistory> {
  ...
  Widget _buildBody(List<History>? data) {
    List<History>? history = data
        ?.where(
          (element) =>
              element.status == "Ditolak By System" ||
              element.status == "Ditolak By Sistem"||
