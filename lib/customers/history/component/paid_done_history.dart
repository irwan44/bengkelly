...
class PaidDoneHistoryPage extends StatefulWidget {
  const PaidDoneHistoryPage({super.key});

  @override
  State<PaidDoneHistoryPage> createState() => _PaidDoneHistoryPageState();
}

class _PaidDoneHistoryPageState extends State<PaidDoneHistoryPage> {
  ...
  Widget _buildBody(List<History>? data) {
    List<History>? history = data
        ?.where((element) => element.status == "Invoice")
        .toList();
    return SafeArea(
      child: RefreshIndicator(
        ...
        child: Padding(
          ...
          child: SizedBox(
            ...
            child: history!.isNotEmpty ? ListView.builder(
              shrinkWrap: true,
