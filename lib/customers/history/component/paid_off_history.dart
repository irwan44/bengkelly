...
class PaidOffHistory extends StatefulWidget {
  const PaidOffHistory({super.key});

  @override
  State<PaidOffHistory> createState() => _PaidOffHistoryState();
}

class _PaidOffHistoryState extends State<PaidOffHistory> {
  ...
  Widget _buildBody(List<History>? data) {
    List<History>? history =
        data?.where((element) => element.status == "Lunas").toList();
    return SafeArea(
